...
<head>
	...
	<!-- Favicon -->
	<link href="<?php base_url() ?>img/logo_starbuks.png" rel="icon">
...
<div class="container">
	<div class="row">
		<div class="column-12">
			<h1 style="text-align: center;">Halaman Login StarBucks</h1>
			<hr />
		</div>
		<div class="column-6">
			<img src="<?php echo base_url() ?>/img/admin.png" class="img-responsive">
		</div>
		<div class="column-6">
			<br />
			<br />
		...
		<div class="row">
			<div class="col-12 mb-4">
				<a href="index.html" class="navbar-brand mx-5 d-none d-lg-block">
					<img style="height: 50px;" src="<?php base_url() ?>/img/logo_starbuks.png" alt="">
				</a>
			</div>
			<div class="col-12 mb-4">
			...
			<div class="col-12">
				<p class="m-0">&copy; <a href="#">@</a>. All Rights Reserved. Designed by <a href="https://htmlcodex.com">STARBUCKS</a>
				</p>
			</div>
		</div>
	</div>
